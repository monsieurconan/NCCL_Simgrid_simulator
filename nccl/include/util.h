...
enum COLL{REDUCE, ALL_REDUCE, BROADCAST, REDUCE_SCATTER, ALL_GATHER, GATHER, SCATTER, ALL_TO_ALL, SENDRECV, DEBUG};

double getAlgoBandwidth(double time, int size){
    return (double)(size) * 1e-9 / time;
}
